...
final class LicenceRepository
{
    ...
    public function insererLicence(array $donnees): int
    {
        ...
        $stmt->execute([
            ...
            ':mode_licence' => (string)($donnees['mode_licence'] ?? 'distante'),
            ':canal_vente' => (string)($donnees['canal_vente'] ?? 'non_renseigne'),
            ...
            ':business_care_inclus' => $this->normaliserBooleenNullable($donnees['business_care_inclus'] ?? null),
            ':business_care_debut' => !empty($donnees['business_care_debut']) ? (string)$donnees['business_care_debut'] : null,
            ':business_care_fin' => !empty($donnees['business_care_fin']) ? (string)$donnees['business_care_fin'] : null,
    ...
    public function mettreAJourLicence(int $idLicence, array $donnees): void
    {
        $sql = '
            ...
            SET
                ...
                business_care_inclus = :business_care_inclus,
                business_care_debut = :business_care_debut,
                business_care_fin = :business_care_fin,
    ...
    private function normaliserBooleenNullable(mixed $valeur): ?int
    {
        if ($valeur === null || $valeur === '') {
            return null;
        }

        return (int)$valeur === 1 ? 1 : 0;
    }
}
